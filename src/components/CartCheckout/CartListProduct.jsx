  ...
  return (
    <div className='cart-list-product'>
        ...
        <div className='cart-product-information'>
            ...
            <p><span className='text-price'>R$</span> <span className='text-price'>219,00</span> <span className='text-old-price'>R$</span> <span  className='text-old-price'>219,00</span></p>
        </div>
    </div>
  )
}
